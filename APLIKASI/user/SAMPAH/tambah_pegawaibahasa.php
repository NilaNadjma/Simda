<?php
	//Memanggil class Pegawai Bahasa
	...
	<div class="row">
	  ...
	  <div class="col-md-12">
		...
		<div class="card card-primary">
		  ...
		  <!-- /.card-header -->
		  <!-- form start -->
		  <form method="post" action="?page=tambah_pegawaibahasa">
			<div class="card-body">
...
<?php
	if($_POST['submit'])
	{
		...
		$pegawaibahasa->tambah_pegawaibahasa($data_pegawaibahasa);
