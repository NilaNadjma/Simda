<?php
	...
	class Pegawai {
		...
		function tambah_pegawai($data_pegawai){
			...
			mysqli_query($con, "insert into tb_pegawai(id_pegawai,username,password,nama_pegawai)
						values ('$id_pegawai','$username','$password','$nama_pegawai')");
		}
		...
		function update_pegawai($data_pegawai) {
			...
			mysqli_query($con, "update tb_pegawai set username='$username', password='$password', nama_pegawai='$nama_pegawai' where id_pegawai='$id_pegawai'");
		}
	}
?>